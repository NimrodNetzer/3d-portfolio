...
const Footer = () => (
  <footer className='bg-primary py-6 flex flex-col sm:flex-row justify-center items-center gap-4 border-t border-white/5'>
    <div className='flex items-center gap-5'>
      <a
        href='https://github.com/NimrodNetzer'
        target='_blank'
        rel='noreferrer'
        aria-label='GitHub'
      ...
      <a
        href='https://www.linkedin.com/in/nimrod-netzer-8360b8294/'
        target='_blank'
        rel='noreferrer'
        aria-label='LinkedIn'
        className='text-secondary hover:text-white transition-colors'
